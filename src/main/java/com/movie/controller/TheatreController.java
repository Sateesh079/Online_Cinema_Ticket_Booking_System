...
public class TheatreController {
 ...
 public String saveTheater(
         @ModelAttribute("theater") Theatre theater, Model m, HttpSession session) {
  if (session.getAttribute("admin") == null) {
   return "redirect:/";
  }
 ...
 public String getupdateTheatre(
         @PathVariable("id") Integer theatreId, Model m, HttpSession session) {
  if (session.getAttribute("admin") == null) {
   return "redirect:/";
  }
